...
class ExtractFileContents implements ShouldQueue
{
    ...
    private function createActivity($roasterId, $data)
    {
        return Activity::create([
            ...
            'code' => Helpers::getCode($data['Activity']),
            'description' => Helpers::getCodeDescription(Helpers::getCode($data['Activity'])),
            'remark' => $data['Remark'] !== " " ? $data['Remark'] : null,
            'from' => $data['From'] !== " " ? $data['From'] : null,
            'std' => Helpers::convertToTimeFormat($data['STD(Z)']),
            'to' => $data['To'] !== " " ? $data['To'] : null,
            'sta' => Helpers::convertToTimeFormat($data['STA(Z)']),
            'remarks' => $data['Remark'] !== " " ? $data['Remark'] : null,
            'blh' => $data['BLH'] !== " " ? $data['BLH'] : null,
            'flight_time' => $data['Flight Time'] !== " " ? $data['Flight Time'] : null,
            'night_time' => $data['Night Time'] !== " " ? $data['Night Time'] : null,
            'duration' => $data['Dur'] !== " " ? $data['Dur'] : null,
            'ext' => $data['Ext'] !== " " ? $data['Ext'] : null,
            'pax_booked' => $data['Pax booked'] !== " " ? $data['Pax booked'] : null,
            'ac_reg' => $data['ACReg'] !== " " ? $data['ACReg'] : null,
        ]);
    }
